...
# This is exactly what LangChain's @tool decorator tool generates automatically
# from the functino's type hints and docstring
...
tools_for_llm = [
    ...
    },
    {
        ...
        "function": {
            "name": "apply_discount",
            "description": "Apply a discount tier to a price and return the final price. Availabe tiers: bronze, silver, gold.",
            "parameters": {
                "type": "object",
                "properties": {
...
def run_agent(question: str):
    ...
    logger.info("=" * 60)
    # Difference 4: way the prompt messages are feeded to llm
    messages = [
        {
            "role": "system",
            "content": (
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        # Difference 8: How tool response is appended to system prompt
        messages.append(
            {
                "role": "tool",
