...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        logger.info("  [Parsing] Looking for Final Answer in LLM output...")
        ...
        logger.info("  [Parsing] Looking for Action and Action Input in LLM output...")
        ...
        logger.info(f"  [Tool Selected] {tool_name} with args: {tool_input_raw}")
    ...
    logger.info("ERROR: Max iterations reached without a final answer")
    return None
