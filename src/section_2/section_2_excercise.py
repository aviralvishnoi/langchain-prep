...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama_4_response = implement_query_model(implement_llama_4_model(), prompt)
    llama_3_3_response = implement_query_model(implement_llama_3_3_model(), prompt)

    return {
        "llama-4-8b-instant": llama_4_response,
        "llama-3.3-70b-versatile": llama_3_3_response,
    }
